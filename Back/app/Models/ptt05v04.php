...
class ptt05v04 extends Model
{
    use HasFactory;
    protected $table = 'ptt05.ptt05v04';

    protected $primaryKey = 'id_v04';
    ...
    public function scopeWithOperationName($query)
    {
        $query
            ...
            ->leftJoin('pak65.pak65e045', 'pak65.pak65e045.p018', DB::Raw("CAST(ptt05v04.cipher_of_the_operation AS INTEGER)"));
    }
    ...
    public function scopeWithHardwareName($query)
    {
        $query
            ...
            ->leftJoin('pak01.pak01e01', 'pak01.pak01e01.p501', DB::Raw("CONCAT('0000', ptt05v04.hardware_cipher)"));
    }
    ...
    public function scopeWithProfessionName($query)
    {
        $query
            ...
            ->leftJoin('pkt50_v', function (JoinClause $join) {
                $join
                    ->on('pkt50_v.profcode70', 'ptt05v04.cipher_of_the_profession')
                    ->on('pkt50_v.kategoryprof', 'ptt05v04.type_of_profession_reference_book');
            });
    }
}
